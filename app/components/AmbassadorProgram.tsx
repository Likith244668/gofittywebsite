    ...
    >
      <div className="mx-auto max-w-7xl text-white">
        ...
        >
          ...
          <div className="rounded-2xl sm:rounded-3xl border border-white/10 bg-white/5 p-6 sm:p-8">
            <h3 className="mb-3 text-xl sm:text-2xl">Apply Now</h3>
            <form
              className="space-y-4"
              onSubmit={(e) => {
                e.preventDefault();
            ...
            >
              <input
                ...
                className="w-full rounded-lg bg-white/5 px-3 py-2.5 text-sm sm:text-base text-white outline-none ring-1 ring-white/10 focus:ring-white/30"
                style={{ fontFamily: 'var(--font-geist-sans)', fontWeight: 400 }}
                required
              />
              <input
              ...
              <textarea
                ...
                className="w-full rounded-lg bg-white/5 px-3 py-2.5 text-sm sm:text-base text-white outline-none ring-1 ring-white/10 focus:ring-white/30 resize-none"
                style={{ fontFamily: 'var(--font-geist-sans)', fontWeight: 400 }}
                rows={4}
              />
              <button
                className="w-full rounded-xl bg-gradient-to-r from-[#fb5607] to-[#ff6b6b] px-6 py-3 text-sm sm:text-base font-bold text-white shadow-[0_8px_30px_rgba(251,86,7,0.4)] transition-all duration-300 hover:scale-105 hover:shadow-[0_12px_40px_rgba(251,86,7,0.6)]"
              >
                Submit Application
              </button>
            </form>
