    ...
    const features = [
        {
            ...
            description: "Complete lifestyle evolution"
        },
        {
            icon: (
                <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <div className="relative z-10">
                                <div className="grid grid-cols-3 gap-3 text-center">
                                    <div>
                                        ...
                                        <div className="text-xs sm:text-sm text-gray-400">Lifestyle</div>
                                    </div>
                                    <div>
                                        <div
                                            className="text-2xl sm:text-3xl lg:text-4xl font-bold text-[#fb5607] mb-1"
                                    ...
                                    <div>
                                        ...
                                        <div className="text-xs sm:text-sm text-gray-400">Potential</div>
                                    </div>
                                </div>
                            </div>
