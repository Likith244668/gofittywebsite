...
export default function ContactSupportFooter() {
  ...
  return (
    <footer
      ref={sectionRef}
      className="pt-12 sm:pt-16 lg:pt-24 px-4 sm:px-6 lg:px-10 xl:px-20"
      style={{ fontFamily: 'var(--font-antonio)', fontWeight: 700, backgroundColor: '#151515' }}
    >
      <div className="mx-auto max-w-7xl text-white">
        <div
          className={`mb-8 sm:mb-10 grid gap-6 sm:gap-8 lg:grid-cols-2 transition-all duration-1000 ${
        ...
        >
          <div className="rounded-2xl sm:rounded-3xl border border-white/10 bg-gradient-to-br from-[#2c0d54] via-[#1e0839] to-[#0f0420] p-6 sm:p-8">
            <h2 className="mb-3 text-2xl sm:text-3xl lg:text-4xl">Contact & Support</h2>
            <p
              className="mb-6 text-sm sm:text-base text-gray-300 lg:text-lg"
              style={{ fontFamily: 'var(--font-geist-sans)', fontWeight: 400 }}
            >
              We're here to help. Reach out for support, partnerships, or press.
            </p>
            <div className="space-y-2 text-sm sm:text-base" style={{ fontFamily: 'var(--font-geist-sans)', fontWeight: 400 }}>
              <p>Email: <a className="underline hover:text-[#fb5607] transition-colors" href="mailto:support@gofytt.com">support@gofytt.com</a></p>
              <p>Phone: <a className="underline hover:text-[#fb5607] transition-colors" href="tel:+10000000000">+1 000 000 0000</a></p>
        ...
        <div className="py-6 sm:py-8 text-center text-xs sm:text-sm text-gray-400" style={{ fontFamily: 'var(--font-geist-sans)' }}>
