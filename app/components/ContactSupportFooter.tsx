            ...
            <div className="flex items-center gap-4 pt-2">
              {socials.map(({ name, href, icon }) => (
                <a
                  key={name}
                  href={href}
                  className="w-10 h-10 rounded-full bg-white/5 flex items-center justify-center text-gray-300 hover:text-white hover:bg-[#fb5607] hover:scale-110 transition-all duration-300"
