...
const members: Member[] = [
  {
    ...
    color: '#fb5607',
    position: {
      mobile: { top: '15%', left: '8%', width: '140px', height: '180px', rotation: -2, zIndex: 2 },
      desktop: { top: '18%', left: '8%', width: '220px', height: '280px', rotation: -2, zIndex: 2 }
    },
    isGrayscale: true
  },
  {
    ...
    color: '#8dd9ff',
    position: {
      mobile: { top: '12%', left: '45%', width: '120px', height: '150px', rotation: 1.5, zIndex: 1 },
      desktop: { top: '10%', left: '32%', width: '200px', height: '250px', rotation: 1.5, zIndex: 1 }
    },
    isGrayscale: true
  },
  {
    ...
    color: '#5ff7b6',
    position: {
      mobile: { top: '8%', left: '68%', width: '130px', height: '160px', rotation: -1, zIndex: 3 },
      desktop: { top: '5%', left: '58%', width: '210px', height: '260px', rotation: -1, zIndex: 3 }
    },
    isGrayscale: false
  },
  {
    ...
    color: '#f6b14b',
    position: {
      mobile: { top: '5%', left: '85%', width: '120px', height: '150px', rotation: 2, zIndex: 1 },
      desktop: { top: '3%', left: '78%', width: '190px', height: '240px', rotation: 2, zIndex: 1 }
    },
    isGrayscale: true
  },
  {
    ...
    color: '#ff6b6b',
    position: {
      mobile: { top: '45%', left: '5%', width: '150px', height: '190px', rotation: 1, zIndex: 2 },
      desktop: { top: '42%', left: '5%', width: '240px', height: '300px', rotation: 1, zIndex: 2 }
    },
    isGrayscale: false
  },
  {
    ...
    color: '#fb5607',
    position: {
      mobile: { top: '38%', left: '42%', width: '180px', height: '220px', rotation: -0.5, zIndex: 5 },
      desktop: { top: '35%', left: '38%', width: '320px', height: '400px', rotation: -0.5, zIndex: 5 }
    },
    isGrayscale: false
  },
  {
    ...
    color: '#8dd9ff',
    position: {
      mobile: { top: '40%', left: '72%', width: '125px', height: '155px', rotation: 2.5, zIndex: 1 },
      desktop: { top: '38%', left: '70%', width: '200px', height: '250px', rotation: 2.5, zIndex: 1 }
    },
    isGrayscale: true
  },
  {
    ...
    color: '#5ff7b6',
    position: {
      mobile: { top: '68%', left: '10%', width: '135px', height: '170px', rotation: -1.5, zIndex: 2 },
      desktop: { top: '65%', left: '12%', width: '220px', height: '280px', rotation: -1.5, zIndex: 2 }
    },
    isGrayscale: false
  },
  {
    ...
    color: '#f6b14b',
    position: {
      mobile: { top: '70%', left: '48%', width: '120px', height: '150px', rotation: 1, zIndex: 1 },
      desktop: { top: '68%', left: '50%', width: '190px', height: '240px', rotation: 1, zIndex: 1 }
    },
    isGrayscale: true
  },
  {
    ...
    color: '#ff6b6b',
    position: {
      mobile: { top: '72%', left: '75%', width: '130px', height: '160px', rotation: -2, zIndex: 2 },
      desktop: { top: '70%', left: '75%', width: '210px', height: '260px', rotation: -2, zIndex: 2 }
    },
    isGrayscale: false
  },
  // Additional floating cards to enrich the collage
  {
    name: 'Runner',
    role: 'Endurance',
    ...
    color: '#8dd9ff',
    position: {
      mobile: { top: '20%', left: '24%', width: '120px', height: '150px', rotation: -3, zIndex: 2 },
      desktop: { top: '18%', left: '22%', width: '190px', height: '240px', rotation: -3, zIndex: 2 }
    },
    isGrayscale: true
  },
  {
    ...
    color: '#5ff7b6',
    position: {
      mobile: { top: '32%', left: '88%', width: '110px', height: '145px', rotation: 2, zIndex: 1 },
      desktop: { top: '28%', left: '85%', width: '180px', height: '230px', rotation: 2, zIndex: 1 }
    },
    isGrayscale: false
  },
  {
    ...
    color: '#f6b14b',
    position: {
      mobile: { top: '55%', left: '32%', width: '130px', height: '165px', rotation: -1.5, zIndex: 2 },
      desktop: { top: '52%', left: '30%', width: '210px', height: '270px', rotation: -1.5, zIndex: 2 }
    },
    isGrayscale: false
  },
  {
    ...
    color: '#fb5607',
    position: {
      mobile: { top: '60%', left: '86%', width: '120px', height: '150px', rotation: 1, zIndex: 2 },
      desktop: { top: '58%', left: '82%', width: '195px', height: '245px', rotation: 1, zIndex: 2 }
    },
    isGrayscale: true
  },
  {
    ...
    color: '#ff6b6b',
    position: {
      mobile: { top: '82%', left: '26%', width: '125px', height: '160px', rotation: 2, zIndex: 1 },
      desktop: { top: '78%', left: '24%', width: '205px', height: '260px', rotation: 2, zIndex: 1 }
    },
    isGrayscale: false
  },
  {
    ...
    color: '#8dd9ff',
    position: {
      mobile: { top: '85%', left: '68%', width: '120px', height: '155px', rotation: -2, zIndex: 2 },
      desktop: { top: '80%', left: '66%', width: '200px', height: '250px', rotation: -2, zIndex: 2 }
    },
    isGrayscale: true
  }
];
...
export default function MembersWall() {
  ...
  return (
    <section 
      ...
      style={{
        // Match site theme background (inherit from main) instead of white
    ...
    >
      <div className="mx-auto max-w-[1400px]">
        ...
        <div 
          className={`absolute top-6 sm:top-8 lg:top-12 left-4 sm:left-6 lg:left-12 xl:left-20 z-50 transition-all duration-1000 ${
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  <div 
                    className={`absolute inset-0 p-4 sm:p-5 lg:p-6 flex flex-col justify-end transition-all duration-500 ${
                      isHovered 
                  ...
                  >
                    ...
                    <div 
                      className={`mt-3 sm:mt-4 transition-all duration-700 delay-100 ${
                        isHovered 
                          ? 'opacity-100 translate-y-0' 
                          : 'opacity-0 translate-y-4'
                      }`}
